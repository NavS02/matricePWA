...
function goToHomePage() {
  router.push({ name: 'HomePage', params: { lingua: route.params.lingua } });
  toggleSidebar()
}
function goToMap() {
...
<template>
  <div>
    <div v-if="route.name !== 'SelectLingua'" class="fixed-icon" @click="toggleSidebar">
      <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4 17H20M4 12H20M4 7H20" stroke="#000000" stroke-width="1.5" stroke-linecap="round"
    ...
    <div :class="['sidebar', { 'sidebar-open': sidebarOpen }]">
      ...
      <div class="sidebar-menu">
        <div style="text-align: center">
          <img src="/logoFioreI.svg" alt="IMAGE" class="main-image" style="width:200px" />
          ...
          <div style="position: relative; margin-top: 10px;">
            <div @click="toggleDropdown"
              ...
              <span style="font-size: 18px; text-transform: capitalize;">{{ route.params.lingua }}</span>
            </div>

            <div v-if="dropdownOpen"
              style="position: absolute; top: 100%; left: 50%; transform: translateX(-50%); background: white; box-shadow: 0 2px 8px rgba(0,0,0,0.15); border-radius: 8px; margin-top: 5px; z-index: 10;">
              <div @click="changeLingua('italiano')" style="padding: 8px 16px; cursor: pointer;">Italiano</div>
              <div @click="changeLingua('english')" style="padding: 8px 16px; cursor: pointer;">English</div>
            </div>
          </div>
        </div>

        <ul>
          <li @click="goToHomePage()">TORNA ALL’INIZIO</li>
          <li @click="goToMap()">MAPPA</li>
          <li @click="goToStoria()">LA NOSTRA STORIA</li>
          <li>INFORMAZIONE</li>
          <li>
